...
const calculaCostoEnvio = (importe, codpostal) =>{
	...
	if( verificaEnvioGratis(importe) === false){
	//se podria optimizar de otra forma el recorrido de array
...
//console.log(calculaCostoEnvio(9000,3000));

const muestraProductoCarrito = () =>{
	//leer de storage
} 


const agregaProductoCarrito = (idprod) => {
	//guardar en storage
}

const eliminaProductoCarrito = (idprod) =>{
	//elimina de storage
}

const sumaCostoProductos = () => {
